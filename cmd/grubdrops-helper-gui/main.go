// grubdrops-helper-gui is a small cross-platform GUI for the
// grubdrops-helper. Designed for non-developer friends on Windows
...
func main() {
	...
	url := "http://" + addr + "/"
	fmt.Println("GrubDrops Helper running at", url)
